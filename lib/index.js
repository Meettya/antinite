...
exports.AntiniteDebugger = exports.AntiniteAuditor = exports.AntiniteService = exports.AntiniteSystem = undefined;
...
var AntiniteAuditor = function () {
  function AntiniteAuditor(options) {
    _classCallCheck(this, AntiniteAuditor);
  }
  ...
  _createClass(AntiniteAuditor, [{
    key: 'setMode',
    value: function setMode(isOn) {
    ...
    key: 'setLogSize',
    value: function setLogSize(size) {
      auditorProcess.setMaxStorageSize(size);
    }
  }]);

  return AntiniteAuditor;
}();
...
var AntiniteDebugger = function () {
  function AntiniteDebugger(options) {
    _classCallCheck(this, AntiniteDebugger);
  }
  /*
...
exports.default = Antinite;
exports.AntiniteSystem = AntiniteSystem;
exports.AntiniteService = AntiniteService;
exports.AntiniteAuditor = AntiniteAuditor;
exports.AntiniteDebugger = AntiniteDebugger;